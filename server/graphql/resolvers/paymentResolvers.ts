...
//     cert: path.resolve(
//       __dirname,
//       "ssl/Getswish_Test_Certificates/Swish_Merchant_TestCertificate_1234679304.pem"
//     ),
//     key: path.resolve(
//       __dirname,
//       "ssl/Getswish_Test_Certificates/Swish_Merchant_TestCertificate_1234679304.key"
//     ),
//     ca: path.resolve(
//       __dirname,
//       "ssl/Getswish_Test_Certificates/Swish_TLS_RootCA.pem"
//     ),
//     passphrase: "swish",
//   };
...
//     cert: path.resolve(
//       __dirname,
//       "ssl/sslp/SEB Customer CA1 v2 for Swish copy.pem"
//     ),
//     key: path.resolve(__dirname, "ssl/sslp/SEB Customer CA1 v2 for Swish.key"),
//     passphrase: null,
//   };
...
//   server.post("/paymentrequests", function (req, res) {
...
//       callbackUrl: "https://webhook.site/9d46f14f-519d-49c8-8d78-d39276e565e5",
...
//       "POST",
//       `${config.host}/api/v1/paymentrequests`,
//       json
//     );
...
//   // Get Payment Request
//   server.get("/paymentrequests/:requestId", function (req, res) {
//     const options = requestOptions(
//       "GET",
//       `${config.host}/api/v1/paymentrequests/${req.params.requestId}`
//     );
...
//   // Create Refund
//   server.post("/refunds", function (req, res) {
//     const json = {
//       payeePaymentReference: "0123456789",
...
//             resp.body["originalPaymentReference"];
...
//   // Get Refund
//   server.get("/refunds/:refundId", function (req, res) {
//     const options = requestOptions(
//       "GET",
...
//   // Get QR Code
//   server.get("/qr/:token", function (req, res) {

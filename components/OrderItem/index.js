    ...
    <div className={styles.container}>
      ...
      <div className={styles.productPhotos}>
        <Image
          ...
          loading="lazy"
          alt="https://productimages.hepsiburada.net/s/34/120/10426321043506.jpg"
        />
        <Image
          className={styles.photo}
          ...
          loading="lazy"
          alt="https://i.ibb.co/ZK2L8cg/kisspng-fashion-model-hugo-boss-pinpoint-resource-of-oklah-mens-fashion-5a78e637c1bde9-3434957015178.png"
        />
      </div>
      <hr />
